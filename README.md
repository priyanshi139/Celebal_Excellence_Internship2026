...
| Week | Topic | Status |
|------|-------|--------|
| [Week 1](week1/week1_PriyanshiMehta.ipynb) | Python, NumPy, Pandas, Linear Algebra, Statistics, Probability | ✅ Done |
| [Week 2](week2/week2_tesla_ml_pipeline.ipynb) | EDA, Feature Engineering, Linear Regression vs Random Forest, Time Series (ADF Test & Forecasting) on Tesla Deliveries Data | ✅ Done |
| [Week 3](week3/Week%203%20Unsupervised_Learning_Country_Data.ipynb) | Unsupervised Learning — K-Means Clustering, DBSCAN, PCA Visualization on Country Metrics Data | ✅ Done |
...
| [Week 8](Week8/Week8_Agentic_AI_Pipeline.ipynb) | Agentic AI — Single Agent Pipeline with Conditional Task Routing, Calculator & Keyword Extraction Tools, Structured JSON Output | ✅ Done |
## Tools Used
- Python 3.10
